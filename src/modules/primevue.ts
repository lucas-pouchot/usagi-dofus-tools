...
import '~/sass/primevue-override.css';
...
export const primeVueTrad: { [key: string]: any } = {
    fr: {
        DataTable: {
            btnApply: 'Valider',
        },
        ...
        emptyFilterMessage: 'Aucun résultats',
    ...
    en: {
        ...
        emptyFilterMessage: 'No result',
        emptyMessage: 'No available option',
    },
};
...
export const install: UserModule = ({ app, router, isClient }) => {
    ...
    app.use(PrimeVue, { ripple: true, locale: primeVueTrad.fr });
